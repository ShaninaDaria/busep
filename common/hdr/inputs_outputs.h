...
const int output1 = 0x01;
const int output2 = 0x02;
const int output3 = 0x03;
const int output4 = 0x04;

const int output5 = 0x05;
const int output6 = 0x06;
const int output7 = 0x07;
const int output8 = 0x08;

const int output9 = 0x09;
const int output10 = 0x0a;
const int output11 = 0x0b;
const int output12 = 0x0c;

const int output13 = 0x0d;
const int output14 = 0x0e;
const int output15 = 0x0f;
const int output16 = 0x10;

const int output17 = 0x11;
const int output18 = 0x12;
const int output19 = 0x13;
const int output20 = 0x14;

const int output21 = 0x15;
const int output22 = 0x16;
const int output23 = 0x17;
const int output24 = 0x18;

const int output25 = 0x19;
const int output26 = 0x1a;
const int output27 = 0x1b;
const int output28 = 0x1c;

const int output29 = 0x1d;
const int output30 = 0x1e;
const int output31 = 0x1f;
const int output32 = 0x20;

const int output33 = 0x21;
const int output34 = 0x22;
const int output35 = 0x23;
const int output36 = 0x24;

const int output37 = 0x25;
const int output38 = 0x26;
const int output39 = 0x27;
const int output40 = 0x28;

const int output41 = 0x29;
const int output42 = 0x2a;
const int output43 = 0x2b;
const int output44 = 0x2c;

const int output45 = 0x2d;
const int output46 = 0x2e;
const int output47 = 0x2f;
const int output48 = 0x30;

const int output49 = 0x31;
const int output50 = 0x32;
const int output51 = 0x33;
const int output52 = 0x34;

const int output53 = 0x35;
const int output54 = 0x36;
const int output55 = 0x37;
const int output56 = 0x38;

const int output57 = 0x39;
const int output58 = 0x3a;
const int output59 = 0x3b;
const int output60 = 0x3c;

const int output61 = 0x3d;
const int output62 = 0x3e;


const int input_size = 125;
const int all_inputs = 0x00;
const int input1 = 0x01;
const int input2 = 0x02;
const int input3 = 0x03;
const int input4 = 0x04;

const int input5 = 0x05;
const int input6 = 0x06;
const int input7 = 0x07;
const int input8 = 0x08;

const int input9 = 0x09;
const int input10 = 0x0a;
const int input11 = 0x0b;
const int input12 = 0x0c;

const int input13 = 0x0d;
const int input14 = 0x0e;
const int input15 = 0x0f;
const int input16 = 0x10;

const int input17 = 0x11;
const int input18 = 0x12;
const int input19 = 0x13;
const int input20 = 0x14;

const int input21 = 0x15;
const int input22 = 0x16;
const int input23 = 0x17;
const int input24 = 0x18;

const int input25 = 0x19;
const int input26 = 0x1a;
const int input27 = 0x1b;
const int input28 = 0x1c;

const int input29 = 0x1d;
const int input30 = 0x1e;
const int input31 = 0x1f;
const int input32 = 0x20;

const int input33 = 0x21;
const int input34 = 0x22;
const int input35 = 0x23;
const int input36 = 0x24;

const int input37 = 0x25;
const int input38 = 0x26;
const int input39 = 0x27;
const int input40 = 0x28;

const int input41 = 0x29;
const int input42 = 0x2a;
const int input43 = 0x2b;
const int input44 = 0x2c;

const int input45 = 0x2d;
const int input46 = 0x2e;
const int input47 = 0x2f;
const int input48 = 0x30;

const int input49 = 0x31;
const int input50 = 0x32;
const int input51 = 0x33;
const int input52 = 0x34;

const int input53 = 0x35;
const int input54 = 0x36;
const int input55 = 0x37;
const int input56 = 0x38;

const int input57 = 0x39;
const int input58 = 0x3a;
const int input59 = 0x3b;
const int input60 = 0x3c;

const int input61 = 0x3d;
const int input62 = 0x3e;
const int input63 = 0x3f;
const int input64 = 0x40;

const int input65 = 0x41;
const int input66 = 0x42;
const int input67 = 0x43;
const int input68 = 0x44;

const int input69 = 0x45;
const int input70 = 0x46;
const int input71 = 0x47;
const int input72 = 0x48;

const int input73 = 0x49;
const int input74 = 0x4a;
const int input75 = 0x4b;
const int input76 = 0x4c;

const int input77 = 0x4d;
const int input78 = 0x4e;
const int input79 = 0x4f;
const int input80 = 0x50;

const int input81 = 0x51;
const int input82 = 0x52;
const int input83 = 0x53;
const int input84 = 0x54;

const int input85 = 0x55;
const int input86 = 0x56;
const int input87 = 0x57;
const int input88 = 0x58;

const int input89 = 0x59;
const int input90 = 0x5a;
const int input91 = 0x5b;
const int input92 = 0x5c;

const int input93 = 0x5d;
const int input94 = 0x5e;
const int input95 = 0x5f;
const int input96 = 0x60;

const int input97 = 0x61;
const int input98 = 0x62;
const int input99 = 0x63;
const int input100 = 0x64;

const int input101 = 0x65;
const int input102 = 0x66;
const int input103 = 0x67;
const int input104 = 0x68;

const int input105 = 0x69;
const int input106 = 0x6a;
const int input107 = 0x6b;
const int input108 = 0x6c;

const int input109 = 0x6d;
const int input110 = 0x6e;
const int input111 = 0x6f;
const int input112 = 0x70;

const int input113 = 0x71;
const int input114 = 0x72;
const int input115 = 0x73;
const int input116 = 0x74;

const int input117 = 0x75;
const int input118 = 0x76;
const int input119 = 0x77;
const int input120 = 0x78;

const int input121 = 0x79;
const int input122 = 0x7a;
...
//    int sizeOfOutputs() const;
    ...
    void setOneInput(int number, input_state state);
    input_state getInputValue(int number);
    char *getAllInputs();
//    int sizeOfInputs() const;
};
